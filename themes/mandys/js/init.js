...
(function($){
	$(function(){
    $('.menu-primary-menu-container').addClass('collapse navbar-collapse');
    $('#menu-primary-menu').addClass('nav navbar-nav');
    $('.custom-logo-link').addClass('navbar-brand scroll');
    $('#description').children('p').addClass('description');
    ...
    // CONTACT PAGE
      ...
      function initialize() {
        var myLatLong = new google.maps.LatLng(-33.9497747,18.4668119);
        var mapOptions = {
          center: myLatLong,
          scrollwheel: false,
          zoom: 13
